...
Showdown.converter = function (a) {
    ...
    var k, l = function (a, b) {
        ...
        if ("" == n)if ("" == m && (m = l.toLowerCase().replace(/ ?\n/g, " ")), n = "#" + m, void 0 != b[m])n = b[m], void 0 != c[m] && (o = c[m]); else {
...
}, "undefined" != typeof module && (module.exports = Showdown), "function" == typeof define && define.amd && define("panels/text/lib/showdown", [], function () {
    return Showdown
}), define("panels/text/module", ["angular", "app", "underscore", "require"], function (a, b, c, d) {
    var e = a.module("kibana.panels.text", []);
    b.useModule(e), e.controller("text", ["$scope", function (a) {
        a.panelMeta = {status: "Stable", description: "A static text panel that can use plain text, markdown, or (sanitized) HTML"};
        var b = {status: "Stable", mode: "markdown", content: "", style: {}};
        c.defaults(a.panel, b), a.init = function () {
            a.ready = !1
        }
    }]), e.directive("markdown", function () {
        return{restrict: "E", link: function (a, b) {
            function c() {
                d(["./lib/showdown"], function (c) {
                    a.ready = !0;
                    var d = new c.converter, e = a.panel.content.replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;"), f = d.makeHtml(e);
                    b.html(f), a.$$phase || a.$apply()
                })
            }
    ...
    }), e.filter("newlines", function () {
        return function (a) {
            return a.replace(/\n/g, "<br/>")
        }
    }), e.filter("striphtml", function () {
        return function (a) {
