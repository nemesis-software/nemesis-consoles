...
!function (a, b, c) {
    var d = a.L, e = {};
    e.version = "0.6-dev", "object" == typeof module && "object" == typeof module.exports ? module.exports = e : "function" == typeof define && define.amd && define("leaflet", [], function () {
        return e
    ...
    e.Mixin = {}, e.Mixin.Events = {addEventListener: function (a, b, c) {
        ...
        var b = e.stamp(a);
        return this._layers[b] ? (this._loaded && (a.onRemove(this), this.fire("layerremove", {layer: a})), delete this._layers[b], this._zoomBoundLayers[b] && (delete this._zoomBoundLayers[b], this._updateZoomLevels()), this.options.zoomAnimation && e.TileLayer && a instanceof e.TileLayer && (this._tileLayersNum--, this._tileLayersToLoad--, a.off("load", this._onTileLayerLoad, this)), this) : void 0
    }, hasLayer: function (a) {
